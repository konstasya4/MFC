                ...
                <div className="column-line">
                  <div className="dateOfIssue column-account">
                    ...
                    <div className="btn-show">
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(userData.passport.dateOfIssue)
                        }
                      >
                        <img src={IconCopy} alt="Copy" />
                      </button>
                ...
                <div className="column-line">
                  <div className="unitCode column-account">
                    ...
                    <div className="btn-show">
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(userData.passport.unitCode)
                        }
                      >
                        <img src={IconCopy} alt="Copy" />
                      </button>
                  ...
                  <div className="placeOfBirth column-account">
                    ...
                    <div className="text-account">
                      {userData.passport.placeOfBrith}
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div>
                  <div className="passportData column-account">
                    ...
                    <div className="btn-show">
                      ...
                      <button
                        onClick={() => copyToClipboard(userData.servicenumber)}
                      >
                        <img src={IconCopy} alt="Copy" />
                      </button>
                    </div>
                  ...
                  <div className="dateOfIssue column-account">
                    ...
                    <div className="btn-show">
                      <div className="text-account">
                        {visibleField === "inn"
                          ? userData.inn
                          : hideData(userData.inn)}
                      </div>
                      <button
                        img={Show}
                        onClick={() => toggleVisibility("inn")}
                      >
                        {visibleField === "inn" ? (
                          <img src={Show}></img>
                        ) : (
